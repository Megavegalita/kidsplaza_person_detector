...
class KerasTFGenderClassifier:
    ...
    def __init__(
        self, model_path: Optional[str] = None, min_confidence: float = 0.3
    ) -> None:
        """
        ...
        if model_path is None:
            default_model_path: Path = (
                ...
                / "cctv_full_body_gender_classification.h5"
            )
        ...
        logger.info("KerasTFGenderClassifier initialized")
        logger.info("Model path: %s", str(self.model_path))
    ...
    def _load_model(self):
        ...
        try:
            ...
            output_shape = (
                ...
                else model.compute_output_shape(input_shape=(None, None, None, 3))
            )
    ...
    def classify(self, crop: np.ndarray) -> Tuple[str, float]:
        ...
        try:
            ...
            logger.debug(
                f"KerasTF outputs: class0={class_0_prob:.3f}, class1={class_1_prob:.3f} -> {gender}"
            )
